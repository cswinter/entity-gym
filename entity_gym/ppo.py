...
import numpy as np
from entity_gym.environment import EnvList, Environment, ObsFilter
...
def parse_args():
    ...
    parser.add_argument('--gym-id', type=str, default="CherryPick",
    ...
    parser.add_argument('--wandb-project-name', type=str, default="enn-bench",
...
class Agent(nn.Module):
    def __init__(self, obs_filter: ObsFilter):
...
if __name__ == "__main__":
    ...
    agent = Agent(env_cls.full_obs_filter()).to(device)
